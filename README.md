...
| 03 | [Purchase Prediction](./03-purchase-prediction) | Feedforward neural network (TensorFlow/Keras), synthetic data with engineered interaction term, baseline comparison vs logistic regression | Accuracy 0.74 (NN) vs 0.75 (logistic regression) vs 0.71 (naive baseline) — NN didn't outperform simpler baseline, likely due to sigmoid activations and limited data |
